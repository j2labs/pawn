from . import Message, to_bytes, to_unicode
...
class WebMessage(Message):
    """Word.
    """
    def __init__(self, sender, conn_id, path, headers, body, url):
        super(WebMessage, self).__init__(sender, conn_id, path, headers, body)
